...
export default {
  ...
  tunnel: 'node -r babel-register ./scripts/localtunnel.js',
  lint: 'eslint . --ext=.js',
  buildWebpack: 'NODE_ENV=production node -r babel-register ./node_modules/.bin/webpack -p --progress --colors --config ./config/webpack.js',
